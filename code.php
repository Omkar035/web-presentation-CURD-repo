...
if (isset($_POST['delete_data'])) {
    ...
    $query = "DELETE FROM presentation WHERE id='$presentation_id'";
...
if (isset($_POST['save_data'])) {
    ...
    $query = "INSERT INTO presentation (ad_format,template,category,average_ctr,dimensions,duration,functionality,reviews,description,demo_link,meta_keywords)  VALUES ('$ad_format','$template','$category','$average_ctr','$dimensions','$duration','$functionality','$reviews','$description','$demo_link','$meta_keywords')";
